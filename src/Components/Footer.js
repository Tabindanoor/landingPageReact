...
const Footer = () => {
  return (
<div className='bg-black text-white py-14 mt-28 text-base pl-[0px] pr-[0px] lg:pl-[65px] lg:pr-[96px] xl:pl-[106px] xl:pr-[187px]'>
                ...
                <li className='text-white text-sm lg:hidden opacity-70 list-none text-center font-sans mt-32'>© 2022 Alexandria Labs. All Right Reserved</li>
            </div>
...
<div className='bg-black text-white mt-6 py-14'>
                <div className='flex justify-between  text-xl  list-none max-lg:flex-col max-lg:gap-6 text-white items-center px-14'>
                    <div >
                        <li className='mb-6'> <img  className="alex w-72 h-24" src="https://alexandria-web-dev.vercel.app/static/media/Frame%20(2).e8ba97920051f1645c15.png"  style={{width:"294.83px",height:"94.1px"}} alt='alex'/></li>
                        <li className='max-lg:hidden text-sm font-sans text-[#F6F6F6]'>© 2022 Alexandria Labs. All Right Reserved</li>
                    </div>
                    <div className='flex gap-6  lg:hidden'>
                        <div>
